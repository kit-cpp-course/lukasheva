...
{	
	...
	{
		maxscore = RecordOut();
		Event e;//Класс отвечающий за события на клавиатуре
		...
		menutext.setFillColor(Color::Yellow);//покрасили текст. если убрать эту строку, то по умолчанию он белый
		...
		recordtext.setFillColor(Color::Yellow);//покрасили текст. если убрать эту строку, то по умолчанию он белый
